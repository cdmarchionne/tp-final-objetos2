...
public class Persona {
    ...
    public Persona(final Integer dni, final String nombre, final String apellido, final String mail,
            final Integer telFijo, final Integer celular, final String direccion, final String sexo,
