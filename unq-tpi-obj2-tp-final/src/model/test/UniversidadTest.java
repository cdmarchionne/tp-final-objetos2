...
public class UniversidadTest extends TestCase {
	...
	// assertNotNull("La universidad se creo correctamente",
	...
	// assertNotNull("Existe una Area en la Universidad",
	// universidad.getAreas());
	//
	// /* Ingreso un Docente y un Alumno al sistema */
	// oficinaDeAlumnos.nuevoDocente(directorCarrera);
	// oficinaDeAlumnos.nuevoAlumno(alumnoPromedio);
	// assertNotNull("Existe un Docente registrado en la Universidad",
	// universidad.getOficinaDeAlumnos().getDocentes());
	// assertNotNull("Existe un Alumno registrado en la Universidad",
	// universidad.getOficinaDeAlumnos().getAlumnos());
	//
	// /* Creo una Carrera */
	...
	// assertNotNull("Existe la carrera en la Universidad",
	// universidad.getCarreras());
	//
	...
	// PlanDeEstudio planDeEstudio = new PlanDeEstudio("Plan Nuevo", new Date(),
	// docente1);
	//
	// /* Asocio un Plan de Estudio que pertenece a una Carrera */
	...
	// planDeEstudio.addMaterias(new MateriaAsignadaAPlanDeEstudio(analisis1,
	// new Obligatoria(), new Cuatrimestral()));
	// planDeEstudio.addMaterias(new MateriaAsignadaAPlanDeEstudio(ingles1, new
	// Optativa(), new Anual()));
	//
	...
	// universidad.getOficinaDeAlumnos().inscribirAlumnoEnCarrera(alumno1,
	// planDeEstudio);
	//
	...
	//
	// /* Inscribo al alumno para que curse una materia */
	// alumno1.inscribirEnMateria(new InscripcionMateria(analisis1,
	// catedraAnalisis1, alumno1));
